# Code of conduct for `open-data-standards`

Contributors to this repository hosted by NHS Digital are expected to
...
[datascience@nhs.net][email-address]. All complaints will be
